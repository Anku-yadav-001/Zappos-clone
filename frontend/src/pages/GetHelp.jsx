...
export function GetHelp() {
    ...
    <Navbar/>
        <div className="w-[95%] m-auto">
            ...
            <img src="https://m.media-amazon.com/images/G/01/Zappos/G4G-HERO-1440x250._FMwebp_.jpg" alt="" />

            <div className="flex flex-col md:flex-row items-center justify-between h-[600px] my-8">
                <div className="w-[40%] flex flex-col justify-center items-start text-left space-y-4 bg-gray-200 p-4 h-full">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between h-[600px] my-8">
                ...
                <div className="w-[40%] flex flex-col justify-center items-start text-left space-y-4 bg-gray-200 p-4 h-full">
                    ...
                    <p className="text-gray-700">
                        Getting the things you love is easy! Just add the item(s) you would like to purchase to your cart, then select “Proceed to Checkout.” You must sign in or create your Zappos.com account. Then, you can add your payment method and complete your order by clicking the “Place Your Order” button on the checkout screen. Yay!   </p>
                    <a href="#" className="text-black font-semibold underline hover:text-blue-800">
                        Start Shoping Now
                    </a>
                </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between h-[600px] my-8">
                <div className="w-[40%] flex flex-col justify-center items-start text-left space-y-4 bg-gray-200 p-4 h-full">
                    ...
                    <p className="text-gray-700">
                        If your account is eligible for a self-service exchange, you will see the option next to your order info. If this option is missing, don’t stress! Simply contact  <a href="">customer service</a> for assistance </p>
                    <a href="#" className="text-black font-semibold underline hover:text-blue-800">
                        Exchnage an Order
                    </a>
                </div>
